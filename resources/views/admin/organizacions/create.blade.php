    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.organizacions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_usuario') ? 'is-invalid' : '' }}" type="text" name="id_usuario" id="id_usuario" value="{{ old('id_usuario', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('empleados') ? 'is-invalid' : '' }}" type="number" name="empleados" id="empleados" value="{{ old('empleados', '') }}" step="1" required>
