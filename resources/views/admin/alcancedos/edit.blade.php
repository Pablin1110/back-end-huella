...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.alcancedo.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.alcancedos.update", [$alcancedo->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('usuario') ? 'is-invalid' : '' }}" name="usuario_id" id="usuario_id" required>
                    @foreach($usuarios as $id => $usuario)
                        <option value="{{ $id }}" {{ (old('usuario_id') ? old('usuario_id') : $alcancedo->usuario->id ?? '') == $id ? 'selected' : '' }}>{{ $usuario }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('periodo_inicial') ? 'is-invalid' : '' }}" type="text" name="periodo_inicial" id="periodo_inicial" value="{{ old('periodo_inicial', $alcancedo->periodo_inicial) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('periodo_final') ? 'is-invalid' : '' }}" type="text" name="periodo_final" id="periodo_final" value="{{ old('periodo_final', $alcancedo->periodo_final) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ubicacion') ? 'is-invalid' : '' }}" type="text" name="ubicacion" id="ubicacion" value="{{ old('ubicacion', $alcancedo->ubicacion) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text" name="nombre" id="nombre" value="{{ old('nombre', $alcancedo->nombre) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('consumo') ? 'is-invalid' : '' }}" type="number" name="consumo" id="consumo" value="{{ old('consumo', $alcancedo->consumo) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('factor_emision') ? 'is-invalid' : '' }}" type="number" name="factor_emision" id="factor_emision" value="{{ old('factor_emision', $alcancedo->factor_emision) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('emisiones_totales') ? 'is-invalid' : '' }}" type="number" name="emisiones_totales" id="emisiones_totales" value="{{ old('emisiones_totales', $alcancedo->emisiones_totales) }}" step="0.01" required>
