...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.huella.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.huellas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alcance_uno') ? 'is-invalid' : '' }}" type="number" name="alcance_uno" id="alcance_uno" value="{{ old('alcance_uno', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alcance_dos') ? 'is-invalid' : '' }}" type="number" name="alcance_dos" id="alcance_dos" value="{{ old('alcance_dos', '') }}" step="0.01" required>
