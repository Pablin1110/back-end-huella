...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.alcanceuno.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.alcanceunos.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lugar') ? 'is-invalid' : '' }}" type="text" name="lugar" id="lugar" value="{{ old('lugar', '') }}">
                @if($errors->has('lugar'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lugar') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('equipo') ? 'is-invalid' : '' }}" type="text" name="equipo" id="equipo" value="{{ old('equipo', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cantidad_inicial') ? 'is-invalid' : '' }}" type="number" name="cantidad_inicial" id="cantidad_inicial" value="{{ old('cantidad_inicial', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cantidad_anual') ? 'is-invalid' : '' }}" type="number" name="cantidad_anual" id="cantidad_anual" value="{{ old('cantidad_anual', '') }}" step="0.01">
